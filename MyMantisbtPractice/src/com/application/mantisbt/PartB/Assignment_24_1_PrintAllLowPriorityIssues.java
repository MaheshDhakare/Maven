...
public class Assignment_24_1_PrintAllLowPriorityIssues {
...
public static void main(String[] args) throws IOException, InterruptedException {
	...
	System.out.println("===================Assignment_24_1_PrintAllLowPriorityIssues=================== ");
		...
		if (objBussPro.validedWebElement(objBussPro.logoutButton)) {
			...
			if (objBussPro.validedWebElement(objBussPro.reportIsstab)) {
					...
					if (objBussPro.validedWebElement(objBussPro.viewIssueTabValidation)) {
						...
						objBussPro.getListOfIssuesWithSamePriority("low");
						System.out.println("==========================================================");
