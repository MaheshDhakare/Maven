...
public class Assignment_9_Synchronisation {

public static void main(String[] args) {
		
	System.setProperty("webdriver.firefox.bin", "C:\\Program Files (x86)\\Mozilla Firefox 41.0\\firefox.exe");		
	Assignment_9_Synchronisation objBussPro = new Assignment_9_Synchronisation();
...
public void LoginToMantic(String URL, String UserName, String Password) {	
		...
		try {
			Wait.until(ExpectedConditions.presenceOfElementLocated(By.partialLinkText("Logout")));
		} catch (Exception e) {
			System.out.println("Waited for 5 sec, unable to locate 'Logout' element");
//			e.printStackTrace();
		}
	}
...
public void reportCreation() {
		...
		try {
			...
			System.out.println("Unable to find button after 5 sec");
//			e.printStackTrace();
		}
