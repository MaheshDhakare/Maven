...
public class Assignment_22_OpenissuePrintseverityEditseverityUpdateseverityConfirmseverityUsingEditIcon {
...
public static void main(String[] args) throws IOException {
	...
	System.out.println("===================Assignment_22_OpenissuePrintseverityEditseverityUpdateseverityConfirmseverityUsingEditIcon=================== ");
			...
			if (objBussPro.validedWebElement(objBussPro.reportIsstab)) {
				...
				if (objBussPro.validedWebElement(objBussPro.viewSubmittedIssueLink)) {
					...
					if (objBussPro.validedWebElement(objBussPro.viewIssueTabValidation)) {
						...
						WebElement editCellInViewIssueTabIcon = objBussPro.getIssueCellFromTheViewIssueTable(issueID, 1, "a");
						editCellInViewIssueTabIcon.click();						
					
						if (objBussPro.validedWebElement(objBussPro.backLink)) {
							
							objBussPro.selectDropdown(objBussPro.editSeverity, "block");
							
							System.out.println("Successfully selected/updated block value");
							System.out.println("==========================================================");
							...
							if (objBussPro.validedWebElement(objBussPro.updateInformationButton)) {
								...
								if (objBussPro.validedWebElement(objBussPro.verifyCurrectIssueOpened)) {
									...
									String updatedseverityValue = objBussPro.getWebElement(objBussPro.verifySeverity).getText();
									
									System.out.println("And the severity for issueID# "+ issueID+ " is updated to " + updatedseverityValue);
									
									System.out.println("==========================================================");
									
									objBussPro.setCellvalue(rowNum, 11, issueID);
									objBussPro.setCellvalue(rowNum, 12, "Passed");
									objBussPro.setCellvalue(rowNum, 13, "severity for issueID# "+ issueID+ " is updated to " + updatedseverityValue);
							...
							} else
							{
								...
								objBussPro.setCellvalue(rowNum, 13, "Unable to find updateInformation Button");
								objBussPro.setCellvalue(rowNum, 12, "Failed");
								objBussPro.closeBrowser();
							}
					...
					{
						System.out.println("Unable to find Vewing Issues cell value");
